import torch
from torch.nn import Module, Linear, Conv2d, ReLU, Sigmoid, Dropout2d, ConvTranspose2d, BatchNorm2d
from torchsummary import summary


class SegnetHyperSpectral(Module):
    def __init__(self):
        super(SegnetHyperSpectral, self).__init__()
        ...
        self.dconv1 = ConvTranspose2d(in_channels=512, out_channels=256, kernel_size=(
            3, 3), padding=1, stride=2, output_padding=1)
        self.bn8 = BatchNorm2d(256)
        self.r8 = ReLU()

        self.dconv2 = ConvTranspose2d(in_channels=256, out_channels=128, kernel_size=(
            3, 3), padding=1, stride=2, output_padding=1)
        self.bn9 = BatchNorm2d(128)
        self.r9 = ReLU()

        self.dconv3 = ConvTranspose2d(in_channels=128, out_channels=64, kernel_size=(
            3, 3), stride=2, padding=1, output_padding=1)
        self.bn10 = BatchNorm2d(64)
        self.r10 = ReLU()

        self.dconv4 = ConvTranspose2d(in_channels=64, out_channels=32, kernel_size=(
            3, 3), stride=2, padding=1, output_padding=1)
        self.bn11 = BatchNorm2d(32)
        self.r11 = ReLU()

        self.dconv5 = ConvTranspose2d(in_channels=32, out_channels=16, kernel_size=(
            3, 3), stride=2, padding=1, output_padding=1)
        self.bn12 = BatchNorm2d(16)
        self.r12 = ReLU()

        self.dconv6 = ConvTranspose2d(
            in_channels=16, out_channels=8, padding=1, stride=2, kernel_size=(3, 3), output_padding=1)
        self.bn13 = BatchNorm2d(8)
        self.r13 = ReLU()

        self.dconv7 = ConvTranspose2d(
            in_channels=8, out_channels=5, padding=1, stride=2, kernel_size=(3, 3), output_padding=1)
        ...
        self.dp7 = Dropout2d(p=0.7)
        self.dp8 = Dropout2d(p=0.7)
        self.dp9 = Dropout2d(p=0.7)
        self.dp10 = Dropout2d(p=0.7)
        self.dp11 = Dropout2d(p=0.7)
